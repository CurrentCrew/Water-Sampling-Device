...
const int alarmPin = 2;  // RTC SQW/INT connected here
...
void setup() {
  ...
  // DS3231_A1_Second means alarm triggers when seconds match

  // Note: Adafruit RTClib does not have explicit armAlarm(), alarms are armed after setAlarm1
...
void loop() {
  if (alarmTriggered) {
    Serial.println("Alarm triggered at start of the minute!");
